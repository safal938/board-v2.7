...
const MeetSidePanel: React.FC = () => {
  ...
  const handleJoinAgent = async () => {
    ...
    try {
      ...
      const API_URL = 'https://api1.medforce-ai.com';
      ...
      if (err.message?.includes('Failed to fetch')) {
        setError('⚠️ Connection Error: Unable to reach API at https://api1.medforce-ai.com. Please check if the API is running and accessible.');
      } else {
